package com.ZSecurity.controller;
...
import com.ZSecurity.dto.ReqRes;
import com.ZSecurity.entity.OurUsers;
import com.ZSecurity.service.UsersManagementService;
...
public class UserManagementController {
	...
	public ResponseEntity<ReqRes> resgister(@RequestBody ReqRes reg) {
	...
	@DeleteMapping("/admin/update/{userId}")
